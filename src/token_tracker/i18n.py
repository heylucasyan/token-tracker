...
_STRINGS = {
    "zh": {
        ...
        "available_cmds": "可用命令: status, dashboard, daily, weekly, monthly, sessions, sidebar, theme, setup, unsetup, --version",
        "dashboard_written": "仪表盘已生成: {path}",
    ...
    "en": {
        ...
        "available_cmds": "Available commands: status, dashboard, daily, weekly, monthly, sessions, sidebar, theme, setup, unsetup, --version",
        "dashboard_written": "Dashboard generated: {path}",
        # --- sidebar（cli.py / ui/sidebar.py）---
